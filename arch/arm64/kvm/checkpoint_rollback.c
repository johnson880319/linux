...
static int kvm_getset_regs(struct kvm_vcpu *vcpu, CPUARMState *env, int set)
{
	...
	// RR_DLOG(INIT, "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
	// RR_DLOG(INIT, "cpu_regs:");
	// for (i = 0; i < 31; ++i)
	// 	RR_DLOG(INIT, "X%d=0x%lx", i, env->kvm_regs.regs.regs[i]);
	// RR_DLOG(INIT, "SP=0x%lx", env->kvm_regs.regs.sp);
	// RR_DLOG(INIT, "PC=0x%lx", env->kvm_regs.regs.pc);
	// RR_DLOG(INIT, "PSTATE=0x%lx", env->kvm_regs.regs.pstate);
	// for (i = 1; i < NR_SYS_REGS; ++i)
	// 	RR_DLOG(INIT, "sys_regs[%d]=0x%lx", i, env->kvm_regs.sys_regs[i]);
...
// static int kvm_getset_fpu(struct kvm_vcpu *vcpu, CPUARMState *env, int set)
// {
...
// static int kvm_getset_xsave(struct kvm_vcpu *vcpu, CPUARMState *env, int set)
// {
...
// static int kvm_getset_xcrs(struct kvm_vcpu *vcpu, CPUARMState *env, int set)
// {
...
// static int kvm_getset_mp_state(struct kvm_vcpu *vcpu, CPUARMState *env, int set)
// {
...
// static int kvm_getset_apic(struct kvm_vcpu *vcpu, CPUARMState *env, int set)
// {
...
// static int kvm_getset_debugregs(struct kvm_vcpu *vcpu, CPUARMState *env, int set)
// {
...
// static int kvm_getset_vcpu_events(struct kvm_vcpu *vcpu, CPUARMState *env, int set)
// {
...
// static int kvm_getset_sregs(struct kvm_vcpu *vcpu, CPUARMState *env, int set)
// {
...
// static int kvm_getset_msrs(struct kvm_vcpu *vcpu, CPUARMState *env, int set)
// {
...
{
	int ret;
	CPUARMState *env = &(vcpu->rr_info.vcpu_checkpoint);
...
// void print_vcpu_status_info_for_debugging(CPUARMState *env)
// {
// 	int i = 0, j = 0;
// 	struct kvm_regs *kvm_regs = &env->kvm_regs;
// 	struct kvm_fpu *fpu = &env->fpu;
